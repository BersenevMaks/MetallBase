        ...
        private void ReadExcel()
        {
            ...
            Type.Missing, Type.Missing);
                ...
                foreach (Excel.Worksheet excelworksheet in excelsheets)
                {
                    ...
                    int ColD1 = 0, ColMera = 0, ColGost = 0, ColD2 = 0, ColSoder = 0, ColDlina = 0, ColTolsh = 0, ColMark = 0;
                    ...
                    for (int j = 4; j <= cCelRow; j++) //строки
                    {
                        ...
                        for (int i = 1; i <= cCelCol; i++) //столбцы
                        {
                            ...
                            if (temp != "")
                            {
                                if (new Regex(@"^\s*\bD\b\s*1(?=\s|\s*$)", RegexOptions.IgnoreCase).IsMatch(temp))
                                {
                                    tab = new C_InfoTable
                                    {
                                        StartCol = i,
                    ...
                    {
                        ColGost = 0; ColD1 = 0; ColMera = 0; ColSoder = 0; ColGost = 0;
                        name = ""; type = "";
                        Excel.Range cellRange;
                        tab = tabs[k];
                        int endRow = cCelRow;
                        ...
                        for (int i = 1; i <= cCelCol; i++) //столбцы
                        {
                            ...
                            if (temp != "")
                            {
                                ...
                                if (new Regex(@"^\s*\bD\b\s*2(?=\s|\s*$)", RegexOptions.IgnoreCase).IsMatch(temp))
                                {
                                    ColD2 = i;
                                    continue;
                                }
                                if (new Regex(@"(?<=^\s*)\bS\b(?=\s*$)", RegexOptions.IgnoreCase).IsMatch(temp))
                                {
                                    ColTolsh = i;
                                    continue;
                                }
                                if (new Regex(@"\bвсего\b\s*,?\s*(?:тн)?", RegexOptions.IgnoreCase).IsMatch(temp))
                                {
                                    ColMera = i;
                                    continue;
                                }
                                ...
                                if (new Regex(@"(?<=^\s*)\bL\b(?=\s*$)", RegexOptions.IgnoreCase).IsMatch(temp))
                                {
                                    ColDlina = i;
                                    continue;
                                }
                                if (new Regex(@"(?<=^\s*)\bм/с\b(?=\s*$)|марка", RegexOptions.IgnoreCase).IsMatch(temp))
                                {
                                    ColMark = i;
                                    continue;
                                }
                                ...
                                else
                                {
                                    ...
                                    if (ColTolsh > 0)
                                    {
                                        ...
                                        if (temp != "")
                                        {
                                            ...
                                            if (tolsh == "0") tolsh = "";
                                            if (!string.IsNullOrEmpty(tolsh)) prim += "S=" + tolsh + " ";
                                        }
                                    }
                                    ...
                                    if (ColGost > 0)
                                    {
                                        ...
                                        if (temp != "")
                                        {
                                            ...
                                            if (regexParam.RegName.IsMatch(temp))
                                            {
                                                ...
                                                standart = standart.Replace(name, "").Trim();
                                            }
                                        }
                                    }
