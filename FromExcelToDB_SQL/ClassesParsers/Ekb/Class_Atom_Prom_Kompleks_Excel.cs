...
{
    class Class_Atom_Prom_Kompleks_Excel
    {
            ...
            Type.Missing, Type.Missing);
                ...
                foreach (Excel.Worksheet excelworksheet in excelsheets)
                {
                    ...
                    for (int k = 0; k < tabs.Count; k++)
                    {
                        ...
                        if (k < tabs.Count - 2)
                            if (tabs[k].StartCol < tabs[k + 1].StartCol && tabs[k].StartRow >= tabs[k + 1].StartRow)
                            ...
                            if (ColDiam > 0)
                            {
                                if (string.IsNullOrEmpty(tab.Name))
                                {
                                    ...
                                    if (temp != "")
                                    {
                                        ...
                                        if (!string.IsNullOrEmpty(tab.Name))
                                        {
                                            ...
                                            {
                                                if (string.IsNullOrEmpty(standart)) standart = m.Value;
                                                else standart += ", " + m.Value;
                                            }
                                        }
                                    }
                                }
                                if (!string.IsNullOrEmpty(tab.Name))
                                {
                                    ...
                                    if (temp != "")
                                    {
                                        ...
                                        if (ColPrice < 1) ColPrice = ColDiam + 2;
