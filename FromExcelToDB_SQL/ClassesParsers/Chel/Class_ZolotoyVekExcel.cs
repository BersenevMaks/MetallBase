        ...
        private void ReadExcel()
        {
            ...
            Type.Missing, Type.Missing);
                ...
                foreach (Excel.Worksheet excelworksheet in excelsheets)
                {
                    ...
                    int ColRaz = 0, ColDlina = 0, ColMera = 0, ColPrice = 0, ColMark = 0;
                    ...
                    {
                        ColMark = 0; ColPrice = 0; ColDlina = 0; ColMera = 0; ColRaz = 0;
                        Excel.Range cellRange;
                        tab = tabs[k];
                        int endRow = cCelRow;
                        ...
                        for (int j = tab.StartRow; j <= endRow; j++) //строки
                        {
                            int jj = j;
                            for (int i = tab.StartCol + 1; i <= cCelCol; i++) //столбцы
                            {
                                cellRange = (Excel.Range)excelworksheet.Cells[jj, i];
                                if (cellRange.Value != null)
                                    temp = cellRange.Value.ToString().Trim();
                        ...
                        for (int j = tab.StartRow + 1; j <= endRow; j++)
                        {
                            ...
                            {
                                cellRange = (Excel.Range)excelworksheet.Cells[j, tab.StartCol + 1];
                                if (cellRange.Value != null)
                                    temp = cellRange.Value.ToString().Trim();
                                else temp = "";
                                if (temp != "")
