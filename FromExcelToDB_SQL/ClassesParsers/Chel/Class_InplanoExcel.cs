    ...
    class Class_InplanoExcel
    {
        ...
        private void ReadExcel()
        {
            ...
            Type.Missing, Type.Missing);
                ...
                {
                    if (!excelworksheet.Name.ToString().ToLower().Contains("труб")) continue;
                    ...
                    int ColDiam = 0, ColMera = 0, ColGost = 0, ColTolsh = 0, ColMark = 0, ColPrice = 0;
                    ...
                    for (int j = 1; j <= cCelRow; j++) //строки
                    {
                        ...
                        for (int i = 1; i <= cCelCol; i++) //столбцы
                        {
                            ...
                            if (temp != "")
                            {
                                if (new Regex(@"номенклатура|диаметр", RegexOptions.IgnoreCase).IsMatch(temp))
                                {
                                    tab = new C_InfoTable
                                    {
                                        StartCol = i,
                    ...
                    for (int k = 0; k < tabs.Count; k++)
                    {
                        ...
                        for (int i = 1; i <= cCelCol; i++) //столбцы
                        {
                            ...
                            if (temp != "")
                            {
                                ...
                                if (new Regex(@"цена|оптовая", RegexOptions.IgnoreCase).IsMatch(temp))
                                {
                                    if (ColPrice == 0)
                                    {
                                        ColPrice = i;
